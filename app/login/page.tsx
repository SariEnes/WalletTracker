...
export default function LoginPage() {
    ...
    return (
        <main className="min-h-screen bg-[#121212] flex items-center justify-center font-mono p-4">
            <div className="w-full max-w-md bg-[#0A0A0A] border border-[#1F1F1F] p-8 shadow-[0_0_50px_rgba(0,255,65,0.05)]">
                <h1 className="text-cyan-400 text-xl mb-6">
                    AUTHENTICATE
                </h1>
                ...
                <div className="my-8 flex items-center gap-4 text-gray-600 text-xs font-bold uppercase tracking-widest">
                ...
                <button 
                    ...
                    disabled={loading}
                    className="w-full border border-accent-blue text-accent-blue bg-accent-blue/10 font-bold py-3 hover:bg-accent-blue/20 transition-colors disabled:opacity-50 uppercase tracking-widest"
                >
                    CONNECT WALLET
                </button>
            </div>
